...
public class Maze {
    ...
    private void generate() {
        ...
        for (int i = 0; i < rows; i++) {
            int col = 1 + new Random().nextInt(cols - 1);
            int row = 1 + new Random().nextInt(rows - 1);
            north[col][row] = false;
            south[col][row + 1] = false;
            east[col][row + 1] = false;
            west[col][row + 1] = false;
        }

        // add some random walls
//        for (int i = 0; i < cols; i++) {
//            int col = cols / 2 + new Random().nextInt(cols / 2);
//            int row = rows / 2 + new Random().nextInt(rows / 2);
