...
/**
 *  The {@code game.StdDraw} class provides a basic capability for
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code game.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">game.StdDraw.java</a>
 ...
 *           game.StdDraw.setPenRadius(0.05);
 *           game.StdDraw.setPenColor(game.StdDraw.BLUE);
 *           game.StdDraw.point(0.5, 0.5);
 *           game.StdDraw.setPenColor(game.StdDraw.MAGENTA);
 *           game.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code game.StdDraw.line()} and {@code game.StdDraw.point()}
 *  draw lines and points; the methods {@code game.StdDraw.setPenRadius()}
 *  and {@code game.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code game.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   game.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code game.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code game.StdDraw.setPenColor(game.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code game.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code game.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   game.StdDraw.setFont(font);
 *   game.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code game.StdDraw.clear(game.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   game.StdDraw.setScale(-2, +2);
 *   game.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       game.StdDraw.clear();
 *       game.StdDraw.filledCircle(x, y, 0.05);
 *       game.StdDraw.filledCircle(-x, -y, 0.05);
 *       game.StdDraw.show();
 *       game.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code game.StdDraw.BLACK}, {@code game.StdDraw.BLUE}, {@code game.StdDraw.CYAN},
     * {@code game.StdDraw.DARK_GRAY}, {@code game.StdDraw.GRAY}, {@code game.StdDraw.GREEN},
     * {@code game.StdDraw.LIGHT_GRAY}, {@code game.StdDraw.MAGENTA}, {@code game.StdDraw.ORANGE},
     * {@code game.StdDraw.PINK}, {@code game.StdDraw.RED}, {@code game.StdDraw.WHITE}, and
     * {@code game.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to game.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to game.StdDraw)
        try {
            URL url = game.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
